    ...
    <section className="py-24 px-6" aria-labelledby="certifications-heading">
      <div className="max-w-6xl mx-auto">
        <SectionReveal className="mb-10">
          <p className="text-cyan-300 uppercase tracking-[0.16em] text-xs mb-3">{certifications.eyebrow}</p>
        ...
        {isMobile ? (
          <AutoCarousel
            ...
            getItemKey={(certification) => certification.title}
            itemClassName="basis-[92%]"
            renderItem={(certification) => (
              <article className="group h-full rounded-2xl border border-white/10 bg-slate-900/65 p-6 shadow-[0_24px_50px_-30px_rgba(34,197,255,0.55)]">
                <div className="flex items-start gap-4">
                  <div className="relative size-16 shrink-0 overflow-hidden rounded-xl border border-white/10 bg-slate-950/70 p-1.5">
                    <Image
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-xl font-semibold text-white leading-tight">{certification.title}</h3>
                    ...
                    <p className="mt-1 text-xs text-cyan-300">{certification.date}</p>
                  </div>
                </div>

                <p className="mt-5 text-slate-300 leading-relaxed text-sm">{certification.description}</p>
